...
public class SeckillSessionController {
    ...
    @GetMapping("/next3DaysSessions")//n.313
    public R getNext3DaysSessions(){
        List<SeckillSessionEntity> seckillSessionEntityList = seckillSessionService.getNext3DaysSessions();
